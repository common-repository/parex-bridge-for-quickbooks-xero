...
class PXB_Missing_Dependency_Reporter {
	...
	public function bindToAdminHooksPXB() {
		add_action( 'admin_notices', array( $this, 'displayAdminNoticePXB' ) );
	}

	public function displayAdminNoticePXB() {
